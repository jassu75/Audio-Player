...
import EmptySongsPage from "../Homepage/EmptySongs";
...
const SelectedPlaylist = () => {
    ...
    return (<Grid2 className={styles.playlist_songs}>
        ...
        {!playlistSongs || Object.keys(playlistSongs).length !== 0 ?
            <PlaylistSongsList playlistId={playlistId} songsList={playlistSongs} /> : <EmptySongsPage />
        }
    </Grid2>
    );
}
